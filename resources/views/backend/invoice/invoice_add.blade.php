                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="md-3">
                                        ...
                                        <i class="btn btn-secondary btn-rounded waves-effect waves-light fa-solid fa-circle-plus addeventmore"
                                            style="width: 37%;">
                                            Add More</i>
                                    </div>
                                </div>
        ...
        <script id="document-template" type="text/x-handlebars-template">
                                                                                            ...
                                                                                            <tr class="delete_add_more_item" id="delete_add_more_item">
                                                                                                ...
                                                                                                <td>
                                                                                                 ...
                                                                                                 <td>
                                                                                                    <i class="btn btn-danger btn-sm fas fa-window-close removeeventmore" style="width: 70%"></i>
                                                                                                </td>
