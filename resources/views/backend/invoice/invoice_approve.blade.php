                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ route('invoice.pending.list') }}"
                                class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i
                                    class="fa fa-list"></i> Pending Invoice List</a> <br> <br>
                            ...
                            <table class="table table-dark" width="100%">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <p>Mobile Number: <strong>{{ $payment['customer']['phone'] }}</strong></p>
                                        </td>
                                        <td>
                                ...
                                <table  class="table table-dark" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" style="background-color: cadetblue">Current Stock</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($invoice['invoice_details'] as $key => $details )
                                            ...
                                            <input type="hidden" name="selling_qty[{{ $details->id }}]" value="{{ $details->selling_qty }}">
                                                ...
                                                <td class="text-center" style="background-color: cadetblue">{{ $details['product']['quantity']  }}</td> 
