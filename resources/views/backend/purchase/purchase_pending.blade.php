                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{ route('purchase.add') }}" class="btn btn-dark btn-rounded waves-effect waves-light"
                                style="float:right;"> <i class="fa-solid fa-circle-plus"></i> Purchase Pending </a> <br> <br>
                                    ...
                                    @foreach($allData as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if ($item->status == '0')
                                                    <a href="{{ route('purchase.approve',$item->id) }}" class="btn btn-success sm" title="Approved" id="ApprovedBtn"> <i
