                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach($allData as $key => $item)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center"> <span class="btn btn-success">{{ $buying_total }}</span>
                                                                </td>
                                                                <td class="text-center"> <span class="btn btn-info">{{ $selling_total }}</span>
                                                                </td>
                                                                <td class="text-center"> <span class="btn btn-primary">{{ $item->quantity }}</span>
                                                                </td>
