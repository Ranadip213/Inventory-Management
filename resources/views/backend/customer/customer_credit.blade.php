...
@section('admin')
 ...
 <div class="page-content">
    ...
    <a href="{{ route('customer.add') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fa fa-print"> </i>Print Credit Customer  </a> <br>  <br>               
