...
@section('admin')
 ...
 <div class="page-content">
    ...
    <a href="{{ route('product.add') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fa-solid fa-circle-plus"></i>Add Product </a> <br>  <br>               
